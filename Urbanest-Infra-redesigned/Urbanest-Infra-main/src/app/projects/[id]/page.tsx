...
export default function ProjectDetailsPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const project = {
    ...
    images: [
      "/images/project-emerald-heights.jpeg",
        ...
        >
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="bg-muted px-3 py-1 text-xs uppercase tracking-widest font-medium rounded-full shadow-sm">RERA: {project.rera}</span>
            </div>
          ...
          <section>
            ...
            <div className="w-full h-80 bg-muted flex items-center justify-center border border-border shadow-inner">
