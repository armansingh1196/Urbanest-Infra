    ...
    <div className="pt-24 md:pt-32 min-h-screen px-4 md:px-16 max-w-7xl mx-auto pb-24">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-24 items-start">
        <div className="w-full">
          <form className="space-y-6 md:space-y-10 bg-card p-6 md:p-12 border border-border shadow-xl plan-corners relative z-10">
            ...
            <Button className="w-full bg-primary text-primary-foreground hover:bg-primary/90 rounded-none py-6 md:py-7 mt-6 uppercase tracking-[0.2em] font-mono text-[10px] md:text-xs transition-transform hover:-translate-y-0.5">
              Send Message
            </Button>
          </form>
        </div>

        <div className="space-y-6 md:space-y-12 md:pt-4">
