...
export default function AboutPage() {
  return (
    <div className="pt-32 min-h-screen">
      <div className="max-w-5xl mx-auto px-4 md:px-16 text-center mb-16 md:mb-20">
        <span className="font-mono text-[10px] md:text-[11px] uppercase tracking-[0.25em] text-primary">About Urbanest</span>
        <h1 className="text-3xl sm:text-4xl md:text-6xl font-serif tracking-wide mt-4 mb-6 md:mb-8 leading-tight">
          We read the ground before you buy the plot.
        </h1>
        <p className="text-muted-foreground font-light text-base md:text-lg leading-relaxed max-w-3xl mx-auto">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-16 grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 mb-20 md:mb-32">
        <div className="plan-corners bg-card border border-border p-6 md:p-8">
          <ShieldCheck className="w-8 h-8 text-primary mb-4" />
          <h3 className="font-serif text-lg sm:text-xl mb-3">Verified developers</h3>
        ...
        <div className="plan-corners bg-card border border-border p-6 md:p-8">
          ...
          <h3 className="font-serif text-lg sm:text-xl mb-3">No hidden margins</h3>
          <p className="text-muted-foreground font-light text-xs sm:text-sm leading-relaxed">
        ...
        <div className="plan-corners bg-card border border-border p-6 md:p-8">
          ...
          <h3 className="font-serif text-lg sm:text-xl mb-3">Local, not remote</h3>
          <p className="text-muted-foreground font-light text-xs sm:text-sm leading-relaxed">
      ...
      <section className="site-stone blueprint-grid py-16 md:py-24 px-4 md:px-16 w-full">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl sm:text-2xl md:text-3xl font-serif tracking-wide mt-4 leading-relaxed">
